...
public class FleetActivity extends AppCompatActivity {
    ...
    public void save(View view) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("Cars/"+time);
        User x = new User("Name: "+names,"Reg No: "+email,"Capacity: "+age);
        progress.show();
        ref.setValue(x).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful())
                {
                    ...
                    {
                        Toast.makeText(FleetActivity.this, "Failed. Try Again", Toast.LENGTH_SHORT).show();
                    }
            }
        });
